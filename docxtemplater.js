  ...
  return _createClass(Docxtemplater, [{
    ...
    value: function resolveData(data) {
      ...
      return Promise.resolve(data).then(function (data) {
        ...
        var _loop = function _loop() {
          ...
          promises.push(Promise.resolve(data).then(function (data) {
    ...
    value: function render(data) {
      ...
      for (var _i44 = 0; _i44 < output.length; _i44++) {
        var _output$_i = _slicedToArray(output[_i44], 2),
          _to = _output$_i[0],
...
var wrapper = __webpack_require__(899);
var _require2 = __webpack_require__(207),
  isWhiteSpace = _require2.isWhiteSpace;
var moduleName = "loop";
...
function writeUtf8(parts, output) {
  ...
  for (var _i4 = 0; _i4 < parts.length; _i4++) {
    ...
    for (var i = 0; i < part.length; i++) {
      ...
      if (pendingHighSurrogate !== -1) {
        if ((codePoint & 0xfc00) === 0xdc00) {
          writeCodePoint(0x10000 + (pendingHighSurrogate - 0xd800 << 10) + (codePoint - 0xdc00));
          pendingHighSurrogate = -1;
          continue;
        }
        writeCodePoint(pendingHighSurrogate);
